...
CREATE TABLE "UpdatedPoint" (
    ...
    CONSTRAINT "UpdatedPoint_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "UpdatedPoint" ADD CONSTRAINT "UpdatedPoint_updateId_fkey" FOREIGN KEY ("updateId") REFERENCES "Update"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
